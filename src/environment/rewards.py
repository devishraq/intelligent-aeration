...
class RewardCalculator:
    def __init__(self, energy_weight=0.5, snh_violation_weight=0.2,ntot_violation_weight=0.1, energy_scale=1000.0):
...
class ZAMORRewardCalculator:
    ...
    def __init__(self, energy_scale=1000.0, barrier_weight=0.5, cascade_weight=0.15, smoothness_weight=0.05, ntot_penalty_weight=1.5, buffer_snh=2.5, buffer_ntot=14.0):
        self.energy_scale = energy_scale
    ...
    def compute_composite_reward(self, avg_ae, effluent_snh, effluent_ntot,tank_snhs=None, klas=None, **_extra):
        ...
        barrier = (
            self._log_barrier(effluent_snh, LIMIT_SNH)+ self._log_barrier(effluent_ntot, LIMIT_NTOT)
        )
